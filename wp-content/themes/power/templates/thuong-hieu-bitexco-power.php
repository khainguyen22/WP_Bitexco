...
<div class="tuyen-dung bitxeco-brand-page">
    <section class="banner bitexco-brand" style='background-image:url("<?php echo $banner['background']; ?>")'>
        <div class="container">
            <div class="content">
    ...
    <section class="about-bitexco">
        <div class="about-bitexco-container">
            <div class="about-bitexco-content">
                <div class="about-bitexco-column text">
                    ...
                    <p><?php echo isset($ve_bitexco_power['description']) ? $ve_bitexco_power['description'] : ""; ?></p>
                    <?php if ($ve_bitexco_power['button']) : ?>
                        <a href="<?php echo $ve_bitexco_power['button']; ?>" class="btn btn-detail ">
                            ...
                            <svg width="16" height="10" viewBox="0 0 16 10" fill="#DAA622" xmlns="http://www.w3.org/2000/svg">
                                <path d="M11.1297 8.66927L14.1482 5.65078C14.5062 5.2928 14.5062 4.7124 14.1482 4.35442L11.1297 1.33594M13.8797 5.0026L1.04639 5.00261" stroke="#DAA622" stroke-width="1.5" stroke-linecap="round"></path>
                            </svg>
                        </a>
                    <?php endif; ?>
                </div>
        ...
        <div class="brand-quote-container">
            <div class="brand-quote-content">
                ...
                <div class="quote-text" style='background-image:url("<?php echo $chu_tich_tap_doan_bitexco_power['background']; ?>")'>
                    ...
                    <p class="content-quote"><?php echo isset($chu_tich_tap_doan_bitexco_power['quote']) ? $chu_tich_tap_doan_bitexco_power['quote'] : ""; ?></p>
                    <div class="quote-divider"></div>
                    <p class="company-role"> <?php echo isset($chu_tich_tap_doan_bitexco_power['position']) ? $chu_tich_tap_doan_bitexco_power['position'] : ""; ?></p>
    ...
    <section class="your-privilege power-enviroment social-responsibility">
        <div class="your-privilege-container">
            <div class="your-privilege-content">
                <div class="content">
                    <span class="divider"></span>
                    <h3><?php echo isset($trach_nhiem_xa_hoi['title'] ) ? $trach_nhiem_xa_hoi['title'] : ""; ?></h3>
                    <p><?php echo isset($trach_nhiem_xa_hoi['description']) ? $trach_nhiem_xa_hoi['description'] : ""; ?></p>
                </div>
                <div class="values">
                    <?php if ($tab_content) : ?>
    ...
    <section class="core-value">
        <div class="core-value-container">
            <div class="content">
                ...
                <p><?php echo isset($gia_tri_cot_loi['description']) ? $gia_tri_cot_loi['description'] : ""; ?></p>
            </div>
        ...
        <div class="your-privilege-container">
            <div class="your-privilege-content">
                <div class="content">
                    ...
                    <p><?php echo isset($thanh_tuu_dat_duoc['description']) ? $thanh_tuu_dat_duoc['description'] : ""; ?></p>
                </div>
                    ...
                    <?php foreach ($list_thanh_tuu_dat_duoc as $key => $value) : ?>
                        <div class="culmulative-output figure">
                            ...
                            <div class="figure-text">
                                ...
                                <p class="unit"><?php echo $value['unit'] ?></p>
                            </div>
                        </div>
                    <?php endforeach; ?>
                <?php endif; ?>
        ...
        <div class="your-privilege-container">
            <div class="your-privilege-content">
                <div class="content">
                    ...
                    <p><?php echo isset($doi_tac_cua_chung_toi['description']) ? $doi_tac_cua_chung_toi['description'] : ""; ?></p>
                </div>
