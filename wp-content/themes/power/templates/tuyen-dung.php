...
<div class="tuyen-dung">
    <section class="banner recruit" style='background-image:url("<?php echo $banner['background']; ?>")'>
        <div class="container">
            <div class="content">
                ...
                <div class="quote">
                    ...
                    <div class="quote-content">
                        ...
                        <div class="quote-text">
                            <?php if ($slider_nguoi_power_noi_gi) : ?>
                                <?php foreach ($slider_nguoi_power_noi_gi as $key => $value) : ?>
                                    <div class="quote-text-<?php echo $key ?> quote-text-inner active">
        ...
        <div class="your-privilege-container">
            <div class="your-privilege-content">
                <div class="content">
                    ...
                    <p><?php echo isset($cuoc_song_tai_bitexco_power['description']) ? $cuoc_song_tai_bitexco_power['description'] : ""; ?></p>
                </div>
            </div>
        </div>
        <div class="life-in-bitexco">
            <div class="container">
                ...
                <div class="lib-button">
                    <a href="<?php echo $cuoc_song_tai_bitexco_power['link']; ?>" class="btn btn-custom-1 btn-custom-1-l position"><?php echo isset($cuoc_song_tai_bitexco_power['button']) ? $cuoc_song_tai_bitexco_power['button'] : ""; ?></a>
                </div>
            </div>
        </div>
    </section>
    <section class="banner opportunity">
        <div class="container">
            <div class="content">
                ...
                <a href="<?php echo $co_hoi_lam_viec['link']; ?>" class="btn btn-custom-1 btn-custom-1-l position"><?php echo isset($co_hoi_lam_viec['button']) ? $co_hoi_lam_viec['button'] : ""; ?></a>
            </div>
        </div>
    </section>
